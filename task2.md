...
Это ограничило память 512 MB и включило GC логирование.
...
- После 54 запроса — OutOfMemoryError
...
- Максимум достигнут через 47 секунд
...
"One instance of ArrayList is occupying 442,368,176 bytes (86.2% of heap)"
...
4. Ограничить размер коллекции (максимум 100 элементов)
...
Инструменты VisualVM и Eclipse MAT быстро находят источник утечки.
